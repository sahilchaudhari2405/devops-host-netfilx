...
**Step 1: Launch 2 droplet digitalOcean (Ubuntu 22.04):**
...
- Clone your application's code repository onto the EC2 instance:
    ...
    ```bash
    git clone https://github.com/sahilchaudhari2405/devops-host-netfilx.git
    ```
...
- It will show an error cause you need API key
  go add API Key to dockerfile
  ```
  ARG TMDB_V3_API_KEY: here 
  ```
...
pipeline{
    ...
    stages {
        ...
        stage('Checkout from Git'){
            steps{
                git branch: 'main', url: 'https://github.com/sahilchaudhari2405/devops-host-netfilx.git'
            }
        }
        ...
        stage('Deploy to container'){
            steps{
                sh 'docker run -d --name netflix -p 8081:80 username/netflix:latest'
            }
        }
    }
}
